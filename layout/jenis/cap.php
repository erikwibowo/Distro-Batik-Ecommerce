      ...
      <!-- BEGIN SIDEBAR & CONTENT -->
        ...
        <!-- END SALE PRODUCT & NEW ARRIVALS -->
            ...
            <?php 
              ...
              $querypro = mysqli_query($connect, "SELECT * FROM barang a, jenis b, kategori c where a.id_kategori = c.id_kategori and a.id_jenis = b.id_jenis and a.id_jenis = 2  ORDER BY id_barang DESC LIMIT $start, $perpage");
